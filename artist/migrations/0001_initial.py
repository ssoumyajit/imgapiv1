# Generated by Django 3.1.7 on 2021-02-22 03:09
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('hicontext', models.CharField(default='', max_length=255)),
                ('hiphoto', models.ImageField(default='', upload_to='work/')),
                ('hidate', models.DateField(blank=True, null=True)),
                ('hicontent', models.TextField(blank=True, default='')),
                ('hilink', models.URLField(blank=True, default='')),
                ('username', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
